...
const translations = {
  ...
  "ai.loading.projects": { en: "Fetching projects...", no: "Henter prosjekter..." },
  "ai.loading.analyzing": { en: "Analyzing activities...", no: "Analyserer aktiviteter..." },
  "ai.loading.generating": { en: "Generating suggestions...", no: "Genererer forslag..." },
