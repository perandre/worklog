...
const translations = {
  ...
  "ai.error.submit": { en: "Failed to log to Moment", no: "Kunne ikke logge til Moment" },
  "ai.rejected": { en: "rejected", no: "forkastet" },
  "ai.undo": { en: "Undo", no: "Angre" },
  "ai.sent": { en: "Logged", no: "Logget" },
  "ai.error": { en: "Error", no: "Feil" },
  "ai.approveAll": { en: "Approve all", no: "Godkjenn alle" },
  "ai.submit": { en: "Log to Moment", no: "Logg til Moment" },
  "ai.submitting": { en: "Logging to Moment...", no: "Logger til Moment..." },
