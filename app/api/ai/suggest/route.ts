...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    console.log(`[AI] ${preprocessed.activities.length} timeline events, ${pmContext.projects.length} Moment projects, ${pmContext.activityTypes.length} Moment activity types → ${prompt.length} chars`)
