...
function bucketByHour(activities: Activity[], startHour = 0, endHour = 24, timezone = "UTC") {
...
export function processActivities(activities: Activity[], startHour = 0, endHour = 24, timezone = "UTC") {
